...
1) ![Влияние параметра INIT-CLIQUE на время отработки (0.1%)](201.png)
2) ![Влияние параметра INIT-CLIQUE на время отработки (3%)](23.png)
3) ![Влияние параметра INIT-CLIQUE на время отработки (6%)](26.png)
4) ![Влияние параметра INIT-CLIQUE на время отработки (9%)](29.png)
