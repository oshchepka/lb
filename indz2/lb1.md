...
1) ![Влияние параметра INIT-CLIQUE на время отработки (0.1%)](2_0.1.png)
2) ![Влияние параметра INIT-CLIQUE на время отработки (3%)](2_3.png)
3) ![Влияние параметра INIT-CLIQUE на время отработки (6%)](2_6.png)
4) ![Влияние параметра INIT-CLIQUE на время отработки (9%)](2_9.png)
